...
//sql문 작성
$sql = "SELECT serial, subject, author, ent_date, view_cnt FROM usee ORDER BY serial DESC";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		echo "<a href='m03_06_board_contents2.php?serial=". $row['serial'] ."'>";
		echo $row['subject'];
		echo "</a>";
		echo "</td>";
...
?>					
				...
				<div id="board_bottom">
					<p>이전 | 1 | 2 | 3 | 4 | 5 | 다음</p>
					<p id="buttons">
						<a href="m03_07_board_write2.php"><button>글쓰기</button></a>
					</p>
				</div>
			</section>
		</div>

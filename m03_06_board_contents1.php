...
//sql문 작성
$sql = "UPDATE communityy SET view_cnt = view_cnt+1 WHERE serial = ".$serial;

//db 전송
$conn->query($sql);

//sql문 작성
$sql = "SELECT * FROM communityy WHERE serial = ".$serial;
...
?>				
				<div id="board_bottom">
					<div class="board_left">
						<a href="m03_02_communityy.php"><button>목록보기</button></a>
					</div>
					<div class="board_right">
					<a href="m03_09_notify_update1.php?serial=<?php echo $serial?>"><button>수정하기</button></a>
		...
		<script>
			function query_delete(){
				...
				if(ans == true) {
					location.href="m03_10_notify_delete1.php?serial=<?php echo $serial ?>";
				}
			}
			</script>
	</body>
